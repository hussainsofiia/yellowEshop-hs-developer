...
function TypeBody({id,title,discountPrice ,price,description,category,
...
///discunt price
    ...
    return (
        <div   className="sm:flex-grow overflow-hidden shadow-md relative flex flex-col m-5 bg-white z-30 sm:p-10">

        <p className="absolute top-2 right-2 text-xs italic text-gray-400">{category}</p>
        <Image className="cursor-pointer transition duration-150 
        transform hover:scale-110" src={image[0]} height={200} width={200} objectFit="contain"/>
